...
namespace IEEE.Migrations
{
    ...
    [Migration("20260223131401_Added-EventTable-and-EventCategoriesTable")]
    partial class AddedEventTableandEventCategoriesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IEEE.Entities.Event", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("IEEE.Entities.EventCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IEEE.Entities.Event", b =>
                {
                    b.HasOne("IEEE.Entities.EventCategory", "Category")
                        .WithMany("Events")
                        .HasForeignKey("CategoryId")
